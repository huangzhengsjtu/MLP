...
def test_mlp(learning_rate_start=1e-3,learning_rate_end=5e-4, L1_reg=0.000, L2_reg=0.001, 
             n_epochs=100,dataset='mnist.pkl.gz', batch_size=200, n_hidden=500, drop_p = 1.0,
